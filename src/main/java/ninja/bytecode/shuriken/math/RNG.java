...
public class RNG extends Random
{
	...
	{
		return lowerBound + (nextFloat() * ((upperBound - lowerBound) + 1));
	}
	...
	{
		return lowerBound + (nextDouble() * ((upperBound - lowerBound) + 1));
	}
	...
	{
		return (int) d(lowerBound, upperBound);
	}
	...
	{
		return (long) l(lowerBound, upperBound);
	}
