...
public class SimplexOctaveNoise extends PerlinOctaveGenerator
{

	public SimplexOctaveNoise(Random rand, int octaves, int sizeX, int sizeZ)
	{
		this(rand, octaves, sizeX, 1, sizeZ);
	}

	public SimplexOctaveNoise(Random rand, int octaves, int sizeX, int sizeY, int sizeZ)
	{
		super(createOctaves(rand, octaves), rand, sizeX, sizeY, sizeZ);
	}

	public SimplexOctaveNoise(Random rand, int octaves)
	{
