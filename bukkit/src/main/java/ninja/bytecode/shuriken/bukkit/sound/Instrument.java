...
public enum Instrument
{
	...
	BOB_CLOSE_HIGH(new MFADistortion(6, 1.9f).distort(new Audio().s(Sound.ENTITY_FISHING_BOBBER_THROW).vp(1f, 1f))),
	BOB_CLOSE_MID(new MFADistortion(6, 1.5f).distort(new Audio().s(Sound.ENTITY_FISHING_BOBBER_THROW).vp(1f, 0.6f))),
	BOB_CLOSE_LOW(new MFADistortion(6, 0.7f).distort(new Audio().s(Sound.ENTITY_FISHING_BOBBER_THROW).vp(1f, 0.1f))),
	...
	BRITTLE_HIGH(new MFADistortion(6, 1.9f).distort(new Audio().s(Sound.ENTITY_ARMOR_STAND_BREAK).vp(1f, 1f))),
	BRITTLE_MID(new MFADistortion(6, 1.5f).distort(new Audio().s(Sound.ENTITY_ARMOR_STAND_BREAK).vp(1f, 0.6f))),
	BRITTLE_LOW(new MFADistortion(6, 0.7f).distort(new Audio().s(Sound.ENTITY_ARMOR_STAND_BREAK).vp(1f, 0.1f))),
	...
	WOOD_CRACK_HIGH(new MFADistortion(9, 1.9f).distort(new Audio().s(Sound.BLOCK_WOOD_BREAK).vp(0.3f, 1f))),
	WOOD_CRACK_MID(new MFADistortion(9, 1.5f).distort(new Audio().s(Sound.BLOCK_WOOD_BREAK).vp(0.3f, 0.6f))),
	WOOD_CRACK_LOW(new MFADistortion(9, 0.7f).distort(new Audio().s(Sound.BLOCK_WOOD_BREAK).vp(0.3f, 0.1f))),
	...
	DEEP_PUNCH_HIGH(new MFADistortion(8, 1.9f).distort(new Audio().s(Sound.ENTITY_PLAYER_ATTACK_KNOCKBACK).vp(1f, 1f))),
	DEEP_PUNCH_MID(new MFADistortion(8, 1.5f).distort(new Audio().s(Sound.ENTITY_PLAYER_ATTACK_KNOCKBACK).vp(1f, 0.6f))),
	DEEP_PUNCH_LOW(new MFADistortion(8, 0.7f).distort(new Audio().s(Sound.ENTITY_PLAYER_ATTACK_KNOCKBACK).vp(1f, 0.1f))),
	DEEP_CLICK_HIGH(new MFADistortion(6, 1.9f).distort(new Audio().s(Sound.ENTITY_FIREWORK_ROCKET_BLAST).vp(1f, 1f))),
	DEEP_CLICK_MID(new MFADistortion(6, 1.5f).distort(new Audio().s(Sound.ENTITY_FIREWORK_ROCKET_BLAST).vp(1f, 0.6f))),
	DEEP_CLICK_LOW(new MFADistortion(6, 0.7f).distort(new Audio().s(Sound.ENTITY_FIREWORK_ROCKET_BLAST).vp(1f, 0.1f))),
	...
	DEEP_BOOM_HIGH(new MFADistortion(6, 1.9f).distort(new Audio().s(Sound.ENTITY_FIREWORK_ROCKET_LARGE_BLAST_FAR).vp(1f, 1f))),
	DEEP_BOOM_MID(new MFADistortion(6, 1.5f).distort(new Audio().s(Sound.ENTITY_FIREWORK_ROCKET_LARGE_BLAST_FAR).vp(1f, 0.6f))),
	DEEP_BOOM_LOW(new MFADistortion(6, 0.7f).distort(new Audio().s(Sound.ENTITY_FIREWORK_ROCKET_LARGE_BLAST_FAR).vp(1f, 0.1f))),
	DEEP_SQUELCH_HIGH(new MFADistortion(6, 1.9f).distort(new Audio().s(Sound.ENTITY_SLIME_JUMP).vp(1f, 1f))),
	DEEP_SQUELCH_MID(new MFADistortion(6, 1.5f).distort(new Audio().s(Sound.ENTITY_SLIME_JUMP).vp(1f, 0.6f))),
	DEEP_SQUELCH_LOW(new MFADistortion(6, 0.7f).distort(new Audio().s(Sound.ENTITY_SLIME_JUMP).vp(1f, 0.1f))),
	METAL_HIT_HIGH(new MFADistortion(8, 1.9f).distort(new Audio().s(Sound.BLOCK_METAL_HIT).vp(1f, 1f))),
	METAL_HIT_MID(new MFADistortion(8, 1.5f).distort(new Audio().s(Sound.BLOCK_METAL_HIT).vp(1f, 0.6f))),
	METAL_HIT_LOW(new MFADistortion(8, 1f).distort(new Audio().s(Sound.BLOCK_METAL_HIT).vp(1f, 0.2f))),
	WOOD_HIT_HIGH(new MFADistortion(8, 1.9f).distort(new Audio().s(Sound.BLOCK_WOOD_HIT).vp(1f, 1f))),
	WOOD_HIT_MID(new MFADistortion(8, 1.5f).distort(new Audio().s(Sound.BLOCK_WOOD_HIT).vp(1f, 0.6f))),
	WOOD_HIT_LOW(new MFADistortion(8, 1f).distort(new Audio().s(Sound.BLOCK_WOOD_HIT).vp(1f, 0.2f)));
